...
#colors used to plot
colors <- c("YlGnBu","RdPu", "Greens", "Oranges", "Purples", "YlOrRd","YlGnBu","RdPu", "Greens", "Oranges", "Purples", "YlOrRd")

#This will save map plots of each parameter of interest and one multi plot with 6 maps on it. 
# Load data ---------------------------------------------------------
